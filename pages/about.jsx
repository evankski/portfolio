...
function About() {
    ...
    return ( 
        <div>
            ...
            <div className="about">
                <img src="https://media-exp1.licdn.com/dms/image/C5603AQE1c7YIkpYRgA/profile-displayphoto-shrink_400_400/0/1640053888076?e=1655337600&v=beta&t=PuNo7y3kc0e8NEmJz6Y_PV-0zgzrTUnshdcRBULL9LI" alt="picture of evan" width={'25%'} style={{borderRadius: 400/ 2}} className="about-pic"/>
