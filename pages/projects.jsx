            ...
            <div className="all-projects">
                <div className="project-1">
                    ...
                    <div className="bussin-bagels">
                        <h1 className="evan">Bussin Bagels</h1>
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/evankski/bussin-bagels-pq" className="project-link">Code</a>
                        <a target="_blank" rel="noreferrer" href="https://evankski.github.io/bussin-bagels-pq/" className="project-link">Live</a>
                    </div>
                </div>
                <div className="project-1">
                <img src="https://i.imgur.com/OHEfRY5.png" alt="A picture example of fillow" width={'40%'} style={{borderRadius: 100/ 2}} />
                    <div className="bussin-bagels">
                        <h1 className="evan">Fillow</h1>
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/evankski/fillow" className="project-link">Code</a>
                        <a target="_blank" rel="noreferrer" href="https://fillow.herokuapp.com/" className="project-link">Live</a>
                    </div>
                ...
                <div className="project-1">
                    ...
                    <div className="bussin-bagels">
                        <h1 className="evan">A day in the life</h1>
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/evankski/day-in-life-client" className="project-link">Code</a>
                        <a target="_blank" rel="noreferrer" href="https://gregarious-starlight-3d969a.netlify.app/" className="project-link">Live</a>
                    </div>
                </div>
            </div>
        </div>
